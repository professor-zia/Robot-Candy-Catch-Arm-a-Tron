...
int servo1Pos = 90, servo2Pos = 90, servo3Pos = 90, servo4Pos = 30;
...
void setup() {
  ...
  // for an accurate 0 to 180 sweep
  armServo1.attach(servo1Pin, 500, 2400);
...
void loop() {
  ...
  servo1Pos = map(analogValue1, 0, 1024, 180, 0);
  armServo1.write(servo1Pos);

  servo2Pos = map(analogValue2, 0, 1024, 180, 0);
  armServo2.write(servo2Pos);

  servo3Pos = map(analogValue3, 0, 1024, 0, 180);
